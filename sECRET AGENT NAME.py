name = input("Enter youre real name,agent: ")
gadget = input("Enter youre favorite gaget")
...
print("Mission Count as text:", mission_count_text, "-> type:", t
    (mission_count_text))
print("Speed Rating as text:", speed_rating_text, "-> type:", type(speed_rating_text))
print("Status as text:", status_text, "-> type"(status_text))
